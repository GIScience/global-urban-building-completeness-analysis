...
def query_ohsome_api(input_gdf, filter_str):
...
def insert_into_postgres_grid(input_gdf):
    ...
    export_columns = [
        ...
        "osm_road_length_km_2022",
        "osm_road_length_km_2021",
        "osm_road_length_km_2020",
        "osm_road_length_km_2019",
        "osm_road_length_km_2018",
        "osm_road_length_km_2017",
        "osm_road_length_km_2016",
        "osm_road_length_km_2015",
        "osm_road_length_km_2014",
        "osm_road_length_km_2013",
        "osm_road_length_km_2012",
        "osm_road_length_km_2011",
        "osm_road_length_km_2010",
        "osm_road_length_km_2009",
        "osm_road_length_km_2008",
    ]
    input_gdf.reset_index(inplace=True)
    # TODO: make sure to use correct table name here
    input_gdf[export_columns].to_sql(
        "osm_road_length_2023_urban_centers_grid",
        con=con,
        if_exists="append",
    )
...
if __name__ == "__main__":
    ...
    for i, urban_center_id in enumerate(urban_center_ids):
        ...
        join_df["year"] = "osm_road_length_km_" + join_df["timestamp"].dt.year.astype(str)
